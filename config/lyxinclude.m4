...
dnl Ymbstate_t is used if HAVE_WCRTOMB || HAVE_MBRTOWC, see 3rdparty/libiconv/1.18/lib/loop_wchar.h.
...
dnl we build a static lib
    ...
    ICONV_INCLUDES='-I$(top_srcdir)/3rdparty/libiconv/1.18 -I$(top_builddir)/3rdparty/libiconv'
    ICONV_LIBS='\$(top_builddir)/3rdparty/libiconv/liblyxiconv.a'
    ICONV_ICONV_H_IN=3rdparty/libiconv/iconv.h:3rdparty/libiconv/1.18/include/iconv.h.in
  else
    ICONV_INCLUDES=
    AM_ICONV
